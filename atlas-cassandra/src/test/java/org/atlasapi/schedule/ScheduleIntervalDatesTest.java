...
public class ScheduleIntervalDatesTest {
    ...
    public void testEmptyInterval() {
        ...
        assertThat(Iterables.getOnlyElement(new ScheduleIntervalDates(new Interval(date, date))), is(date.toLocalDate()));
    }
    ...
    public void testSingleDayInterval() {
        ...
        assertThat(Iterables.getOnlyElement(new ScheduleIntervalDates(new Interval(start, end))), is(start.toLocalDate()));
    }
    ...
    public void testTwoDayInterval() {
        ...
        assertThat(new ScheduleIntervalDates(new Interval(start, end)), hasItems(start.toLocalDate(), end.toLocalDate()));
    }
    ...
    public void testMultiDayInterval() {
        ...
        assertThat(new ScheduleIntervalDates(new Interval(start, end)), 
    ...
    public void testEmptyIntervalAtMidnight() {
        ...
        assertThat(Iterables.getOnlyElement(new ScheduleIntervalDates(new Interval(start, end))), 
